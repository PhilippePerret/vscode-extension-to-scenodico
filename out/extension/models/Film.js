...
const FilmDb_1 = require("../db/FilmDb");
class Film extends BaseModel_1.BaseModel {
    id;
    titre_affiche;
    titre_original;
    titre_francais;
    ...
    /**
     * Sort function for films (by titre_original, respecting accents/diacritics)
     */
     ...
     * Called after all films are rendered in the panel
     */
    static afterDisplayElements() {
        // No special post-processing needed for films panel
