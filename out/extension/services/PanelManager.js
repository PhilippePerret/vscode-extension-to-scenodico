...
class PanelManager {
    ...
    static async openPanels(context) {
        ...
        // panneaux
        panelClass_1.PanelClass.defineCommonPanelOptions(context);
        const panelDico = new panelClassDico_1.PanelClassDico({ context: context });
        const panelOeuvres = new panelClassOeuvre_1.PanelClassOeuvre({ context: context });
        const panelExemples = new panelClassExemple_1.PanelClassExemple({ context: context });
